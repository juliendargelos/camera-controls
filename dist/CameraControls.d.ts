...
export declare class CameraControls extends EventDispatcher {
    ...
    fitTo(box3OrObject: _THREE.Box3 | _THREE.Object3D, enableTransition: boolean, { side, azimuthAngle, polarAngle, paddingLeft, paddingRight, paddingBottom, paddingTop }?: Partial<FitToOptions>): void;
